        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="mt-6 text-lg text-primary-foreground/80 max-w-2xl">
              Simplifiez vos expéditions internationales. Réservation en ligne, suivi en temps réel, 
              gestion documentaire — tout en un seul endroit.
            </p>
          ...
          <motion.div
            ...
            className="mt-16 max-w-xl bg-card/10 backdrop-blur-md rounded-2xl p-6 border border-primary-foreground/10"
          >
            ...
            <div className="flex gap-3">
              <Input
                placeholder="Entrez votre n° de référence (ex: SH-2024-0001)"
              ...
              />
              <Button onClick={handleTrack} className="bg-accent text-accent-foreground hover:bg-accent/90 px-6">
                Suivre
              </Button>
            </div>
          </motion.div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
              Une plateforme complète pour gérer vos expéditions de bout en bout.
            </p>
          </div>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading font-bold text-primary-foreground">24/7 Logistics</span>
            </div>
