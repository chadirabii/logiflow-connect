  ...
  const handleUpdate = async () => {
    if (selected) {
      const result = await updateReclamation(selected.id, {
        status: newStatus,
        adminResponse: response || selected.adminResponse,
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Consultez et traitez les réclamations clients.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Select
            value={filter}
            onValueChange={(v) => setFilter(v as ReclamationStatus | "all")}
          >
            ...
            {selected && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    value={newStatus}
                    onValueChange={(v) => setNewStatus(v as ReclamationStatus)}
                  >
