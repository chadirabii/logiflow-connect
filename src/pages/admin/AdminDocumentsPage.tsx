...
import { useAllDocuments } from '@/hooks/useSupabaseData';
import { FileText, Download, Search } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { useState } from 'react';

const TYPE_LABELS: Record<string, string> = { invoice: 'Facture', packing_list: 'Packing List', customs: 'Douane', transport: 'Transport', contract: 'Contrat', other: 'Autre' };
