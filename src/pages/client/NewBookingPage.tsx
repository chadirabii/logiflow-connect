      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <section className="rounded-xl border border-border bg-card p-6">
            <h2 className="font-heading font-semibold text-card-foreground mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => update("originPort", v)}
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => update("destinationPort", v)}
                >
                  <SelectTrigger className="mt-1.5">
                    <SelectValue placeholder="Sélectionner" />
                  </SelectTrigger>
          ...
          <section className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Ex: Textiles, Électronique..."
                  className="mt-1.5"
                  required
                />
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => update("shipmentMode", v)}
                >
                  <SelectTrigger className="mt-1.5">
                    <SelectValue placeholder="Sélectionner" />
                  </SelectTrigger>
              ...
              <div>
                ...
                <Select
                  value={form.incoterm}
                  onValueChange={(v) => update("incoterm", v)}
                >
                  <SelectTrigger className="mt-1.5">
                    <SelectValue placeholder="Sélectionner" />
                  </SelectTrigger>
              ...
              <div>
                <Label>Date souhaitée d'expédition</Label>
                <Input
                  type="date"
            ...
            <div className="mt-4">
              ...
              <Textarea
                ...
                placeholder="Remarques, précautions..."
                className="mt-1.5"
                rows={3}
              />
            </div>
