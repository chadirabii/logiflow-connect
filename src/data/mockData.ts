...
export const reclamations: Reclamation[] = [
  ...
  { id: 'r3', clientId: 'u4', clientName: 'Ahmed Bouzid', bookingRef: 'BK-2024-0003', subject: 'Erreur sur la facture', description: 'Le montant facturé ne correspond pas au devis initial. Il y a une différence de 500€.', priority: 'medium', status: 'open', createdAt: '2024-10-02', updatedAt: '2024-10-02' },
  { id: 'r4', clientId: 'u6', clientName: 'Fatima Zahra Mejri', subject: 'Problème de température', description: 'Le conteneur reefer n\'a pas maintenu la température requise de 2-8°C pendant le transit.', priority: 'high', status: 'open', createdAt: '2024-10-05', updatedAt: '2024-10-05' },
...
export const bookingRequests: BookingRequest[] = [
  { id: 'b1', clientId: 'u2', referenceNumber: 'BK-2024-0001', fullName: 'Karim Chaabane', company: 'Textile Market SARL', email: 'karim@textilemarket.tn', phone: '+216 20 100 001', originCountry: 'Chine', originPort: 'Port de Shanghai', destinationCountry: 'Tunisie', destinationPort: 'Port de Radès', cargoType: 'Textiles et vêtements', weight: 12000, volume: 65, containerType: "40' High Cube (40HC)", shipmentMode: 'FCL', incoterm: 'CIF - Cost, Insurance and Freight', requestedDate: '2024-08-15', specialInstructions: 'Marchandise fragile, éviter l\'humidité', status: 'in_transit', createdAt: '2024-07-20', updatedAt: '2024-08-10' },
  { id: 'b2', clientId: 'u3', referenceNumber: 'BK-2024-0002', fullName: 'Sophie Martin', company: 'AgroExport France', email: 'sophie@agroexport.fr', phone: '+33 6 12 34 56 78', originCountry: 'Tunisie', originPort: 'Port de Sfax', destinationCountry: 'France', destinationPort: 'Port de Marseille', cargoType: 'Huile d\'olive', weight: 8500, volume: 40, containerType: "20' Standard (20GP)", shipmentMode: 'FCL', incoterm: 'FOB - Free on Board', requestedDate: '2024-09-01', specialInstructions: 'Produit alimentaire, stockage sec', status: 'delivered', createdAt: '2024-08-05', updatedAt: '2024-09-20' },
  { id: 'b3', clientId: 'u4', referenceNumber: 'BK-2024-0003', fullName: 'Ahmed Bouzid', company: 'Tunis Import SA', email: 'ahmed@tunisimport.tn', phone: '+216 20 200 002', originCountry: 'Allemagne', originPort: 'Port de Hambourg', destinationCountry: 'Tunisie', destinationPort: 'Port de Radès', cargoType: 'Pièces automobiles', weight: 15000, volume: 55, containerType: "40' Standard (40GP)", shipmentMode: 'FCL', incoterm: 'DAP - Delivered at Place', requestedDate: '2024-10-01', status: 'confirmed', createdAt: '2024-09-10', updatedAt: '2024-09-25' },
  ...
  { id: 'b12', clientId: 'u6', referenceNumber: 'BK-2024-0012', fullName: 'Fatima Zahra Mejri', company: 'PharmaLog Tunisie', email: 'fatima@pharmalog.tn', phone: '+216 20 300 003', originCountry: 'Italie', originPort: 'Port de Gênes', destinationCountry: 'Tunisie', destinationPort: 'Port de Radès', cargoType: 'Équipement médical', weight: 4000, volume: 20, containerType: "20' Standard (20GP)", shipmentMode: 'FCL', incoterm: 'DDP - Delivered Duty Paid', requestedDate: '2024-12-15', status: 'in_transit', createdAt: '2024-11-20', updatedAt: '2024-12-01' },
];

export const shipments: Shipment[] = [
  { id: 's1', bookingId: 'b1', clientId: 'u2', referenceNumber: 'SH-2024-0001', status: 'in_transit', currentLocation: 'Mer Méditerranée', currentPort: 'En mer', estimatedArrival: '2024-09-05', originPort: 'Port de Shanghai', destinationPort: 'Port de Radès', vessel: 'CMA CGM Marco Polo', containerNumber: 'CMAU2345678', createdAt: '2024-08-10', updatedAt: '2024-08-28' },
  { id: 's2', bookingId: 'b2', clientId: 'u3', referenceNumber: 'SH-2024-0002', status: 'delivered', currentLocation: 'Marseille, France', currentPort: 'Port de Marseille', estimatedArrival: '2024-09-18', originPort: 'Port de Sfax', destinationPort: 'Port de Marseille', vessel: 'MSC Fantasia', containerNumber: 'MSCU9876543', createdAt: '2024-08-20', updatedAt: '2024-09-20' },
  { id: 's3', bookingId: 'b3', clientId: 'u4', referenceNumber: 'SH-2024-0003', status: 'confirmed', currentLocation: 'Hambourg, Allemagne', currentPort: 'Port de Hambourg', estimatedArrival: '2024-10-15', originPort: 'Port de Hambourg', destinationPort: 'Port de Radès', vessel: 'Maersk Sealand', containerNumber: 'MSKU1122334', createdAt: '2024-09-25', updatedAt: '2024-09-25' },
  ...
  { id: 's5', bookingId: 'b9', clientId: 'u3', referenceNumber: 'SH-2024-0005', status: 'customs', currentLocation: 'Gênes, Italie', currentPort: 'Port de Gênes', estimatedArrival: '2024-11-22', originPort: 'Port de Sfax', destinationPort: 'Port de Gênes', vessel: 'Hapag Lloyd Express', containerNumber: 'HLCU3344556', createdAt: '2024-11-01', updatedAt: '2024-11-18' },
  { id: 's6', bookingId: 'b10', clientId: 'u4', referenceNumber: 'SH-2024-0006', status: 'arrived_port', currentLocation: 'La Goulette, Tunisie', currentPort: 'Port de La Goulette', estimatedArrival: '2024-11-30', originPort: 'Port de Barcelone', destinationPort: 'Port de La Goulette', vessel: 'MSC Oscar', containerNumber: 'MSCU7788990', createdAt: '2024-11-10', updatedAt: '2024-11-28' },
  ...
  { id: 's8', bookingId: 'b12', clientId: 'u6', referenceNumber: 'SH-2024-0008', status: 'in_transit', currentLocation: 'Mer Méditerranée', currentPort: 'En mer', estimatedArrival: '2024-12-20', originPort: 'Port de Gênes', destinationPort: 'Port de Radès', vessel: 'CMA CGM Bougainville', containerNumber: 'CMAU9988776', createdAt: '2024-12-01', updatedAt: '2024-12-05' },
];
